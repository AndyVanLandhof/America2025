...
export default function HolidayItinerary() {
  ...
  const tripSegments = [
    ...
    },
    {
      ...
      dates: "Tuesday, 12 August - Sunday, 17 August 2025",
      duration: "5 nights",
      type: "island-resort",
      ...
      dailyItinerary: [
        ...
        },
        {
          ...
          schedule: [
            ...
            { time: "9:00 AM", title: "Check-out", description: "Depart for next destination", type: "arrival" },
            { time: "11:00 AM", title: "Final Island Time", description: "Last moments on Lanai before flight", type: "activity" },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      address: "2727 Shell Beach Rd, Pismo Beach, CA 93449",
      website: "https://www.thedolphinbay.com/",
      dates: "Wednesday, 20 August - Thursday, 21 August 2025",
      duration: "1 night",
      type: "coastal-luxury",
      description: "Oceanfront stay along California’s Central Coast",
      image: "/images/pismo-beach.jpg",
      activities: [
        "Beach walks at Shell Beach",
      ...
      dailyItinerary: [
        {
          ...
          day: "Pismo Arrival",
          schedule: [
            { time: "3:00 PM", title: "Check-in", description: "Arrive at Dolphin Bay and settle in", type: "arrival" },
            { time: "5:00 PM", title: "Cliffside Sunset", description: "Enjoy sunset views along Shell Beach cliffs", type: "activity" },
            { time: "7:30 PM", title: "Dinner", description: "Oceanfront seafood dinner in Pismo Beach", type: "dinner" },
          ],
        },
      ],
    },
